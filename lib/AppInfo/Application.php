...
final class Application extends App implements IBootstrap {
    ...
    /**
     * Route names. Generated by Nextcloud as `<app-id>.<controller-short>.<method>`
     * when controllers carry `#[FrontpageRoute]` attributes — see
     * Controller\CSSController::stylesheet() and Controller\FontController::serve().
     * Centralised here so route renames are a single-file change.
     */
    public const ROUTE_STYLESHEET = self::APP_ID . '.CSS.stylesheet';
    public const ROUTE_FONT       = self::APP_ID . '.Font.serve';
